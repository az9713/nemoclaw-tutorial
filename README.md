# NemoClaw Tutorial — Learning Guide for NVIDIA NemoClaw

> **This is a clone of the original [NVIDIA NemoClaw](https://github.com/NVIDIA/NemoClaw) repository, enhanced with comprehensive tutorial documentation for learning purposes.**
>
> All original source code is unchanged. The additions are:
> - [Architecture Guide](docs/ARCHITECTURE.md) — system design with 25+ ASCII diagrams
> - [Developer Guide](docs/DEVELOPER_GUIDE.md) — step-by-step guide for contributors new to full-stack development
> - [User Guide](docs/USER_GUIDE.md) — complete usage guide with 10 hands-on use cases
> - [How NemoClaw, OpenShell, Docker, and OpenClaw Work Together](docs/HOW_THE_THREE_PROJECTS_WORK_TOGETHER.md) — how the four technologies relate
> - [CLI Reference](docs/CLI_REFERENCE.md) — every command, option, and environment variable
> - [Quick Start](docs/QUICK_START.md) — get running in 5 minutes
> - [Study Plan](docs/STUDY_PLAN.md) — zero-to-hero learning path (14 modules)
> - [CLAUDE.md](CLAUDE.md) — development context for Claude Code sessions
>
...
- [How NemoClaw, OpenShell, Docker, and OpenClaw Work Together](docs/HOW_THE_THREE_PROJECTS_WORK_TOGETHER.md): how the four technologies relate and collaborate
- [Quick Start Guide](docs/QUICK_START.md): get running in 5 minutes
- [User Guide](docs/USER_GUIDE.md): complete usage guide with 10 hands-on use cases
- [Architecture Guide](docs/ARCHITECTURE.md): comprehensive system design with ASCII diagrams
- [Developer Guide](docs/DEVELOPER_GUIDE.md): step-by-step guide for contributors
- [CLI Reference](docs/CLI_REFERENCE.md): every command, option, and environment variable
- [Study Plan](docs/STUDY_PLAN.md): zero-to-hero learning path using this repo
